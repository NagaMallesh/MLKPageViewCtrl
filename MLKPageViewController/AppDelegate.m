...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    MLKPageViewController *mlkPageVC = [[MLKPageViewController alloc] initWithContentViewControllers:[NSArray arrayWithObjects:firstVC, secondVC, thirdVC, nil]];
    
    UINavigationController *mlkNavVC = [[UINavigationController alloc] initWithRootViewController:mlkPageVC];
    
    self.window.rootViewController = mlkNavVC;
